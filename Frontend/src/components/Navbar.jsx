...
function Navbar() {
  ...
  return (
    <>
      <div
  className={`max-w-screen-full fixed top-0 left-0 right-0 ml-5 mr-5 md:px-25 px-4 z-50 transition-all duration-300 ease-in-out ${
    sticky
      ? "sticky-navbar shadow-md bg-white dark:bg-slate-900 dark:text-white"
      : "bg-transparent"
  }`}
>
        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="btn btn-ghost font-bold text-2xl ml-5">Book Store</a>
          </div>
          <div className="navbar-end ">
            <div className="navbar-center ml-auto flex items-center gap-4 hidden lg:flex ">
            ...
            <div>
              <label className="swap swap-rotate ml-4 mr-3">
